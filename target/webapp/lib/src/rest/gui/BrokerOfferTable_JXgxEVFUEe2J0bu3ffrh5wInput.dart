...
class BrokerOfferTable_JXgxEVFUEe2J0bu3ffrh5wInput extends UserInteractionResponse {
	
	DIMEList<Data.Offer> offers = new DIMEList<Data.Offer>();
	
	BrokerOfferTable_JXgxEVFUEe2J0bu3ffrh5wInput(Map<String,dynamic> map, Map<String,dynamic> cache)
	{
	...
	bool inpusChanged(BrokerOfferTable_JXgxEVFUEe2J0bu3ffrh5wInput input) {
