...
class BrokerAssignmentTab_xmnuwVFTEe2J0bu3ffrh5wBranch extends ContinueProcessRequest {
	
	
	Show_bidding branch_Show_bidding;
	
	BrokerAssignmentTab_xmnuwVFTEe2J0bu3ffrh5wBranch.forShow_biddingBranch(
{		Data.Bidding bidding:null
	...
	BrokerAssignmentTab_xmnuwVFTEe2J0bu3ffrh5wBranch.forAssignBranch(
{		Data.Bidding bidding:null
}	) {
	...
	BrokerAssignmentTab_xmnuwVFTEe2J0bu3ffrh5wBranch.forUnassignBranch(
{		Data.Bidding bidding:null
}	) {
	...
	BrokerAssignmentTab_xmnuwVFTEe2J0bu3ffrh5wBranch.forEditBranch(
{		Data.Bidding bidding:null
}	) {
	...
	Map<String,dynamic> toJSOG()
	{
		...
		throw new Exception("Exhaustive IF BrokerAssignmentTab_xmnuwVFTEe2J0bu3ffrh5wBranch.dart");
	}
}
