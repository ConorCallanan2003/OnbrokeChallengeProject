...
class UserRoleBadge_gqOMAVLoEe2djpkPxa2Z3QBranch extends ContinueProcessRequest {
	...
	Map<String,dynamic> toJSOG()
	{
		...
		throw new Exception("Exhaustive IF UserRoleBadge_gqOMAVLoEe2djpkPxa2Z3QBranch.dart");
	}
}
