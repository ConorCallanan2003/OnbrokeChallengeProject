...
class UserAreaHeader_oEUtYVE4Ee2Vgcav4Znc_wBranch extends ContinueProcessRequest {
	...
	Map<String,dynamic> toJSOG()
	{
		...
		throw new Exception("Exhaustive IF UserAreaHeader_oEUtYVE4Ee2Vgcav4Znc_wBranch.dart");
	}
}
