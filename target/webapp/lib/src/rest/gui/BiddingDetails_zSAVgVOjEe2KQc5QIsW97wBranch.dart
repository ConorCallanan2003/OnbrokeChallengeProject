...
class BiddingDetails_zSAVgVOjEe2KQc5QIsW97wBranch extends ContinueProcessRequest {
	
	
	Back branch_Back;
	
	BiddingDetails_zSAVgVOjEe2KQc5QIsW97wBranch.forBackBranch(
	) {
		branch_Back = new Back();
	}
	Show_issue branch_Show_issue;
	
	BiddingDetails_zSAVgVOjEe2KQc5QIsW97wBranch.forShow_issueBranch(
{		Data.Issue issue:null
	...
	BiddingDetails_zSAVgVOjEe2KQc5QIsW97wBranch.forResolve_issueBranch(
{		Data.Issue issue:null
}	) {
	...
	BiddingDetails_zSAVgVOjEe2KQc5QIsW97wBranch.forUnresolve_issueBranch(
{		Data.Issue issue:null
}	) {
	...
	BiddingDetails_zSAVgVOjEe2KQc5QIsW97wBranch.forCreate_issueBranch(
	) {
	...
	Map<String,dynamic> toJSOG()
	{
		...
		throw new Exception("Exhaustive IF BiddingDetails_zSAVgVOjEe2KQc5QIsW97wBranch.dart");
	}
}
