...
class AdminAreaHeader_ikwGUVE4Ee2Vgcav4Znc_wBranch extends ContinueProcessRequest {
	...
	Map<String,dynamic> toJSOG()
	{
		...
		throw new Exception("Exhaustive IF AdminAreaHeader_ikwGUVE4Ee2Vgcav4Znc_wBranch.dart");
	}
}
