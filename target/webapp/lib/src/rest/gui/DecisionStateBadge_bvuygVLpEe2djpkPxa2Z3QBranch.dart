...
class DecisionStateBadge_bvuygVLpEe2djpkPxa2Z3QBranch extends ContinueProcessRequest {
	...
	Map<String,dynamic> toJSOG()
	{
		...
		throw new Exception("Exhaustive IF DecisionStateBadge_bvuygVLpEe2djpkPxa2Z3QBranch.dart");
	}
}
