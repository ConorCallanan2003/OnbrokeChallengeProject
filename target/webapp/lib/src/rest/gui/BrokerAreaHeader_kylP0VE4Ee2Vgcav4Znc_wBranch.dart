...
class BrokerAreaHeader_kylP0VE4Ee2Vgcav4Znc_wBranch extends ContinueProcessRequest {
	...
	Map<String,dynamic> toJSOG()
	{
		...
		throw new Exception("Exhaustive IF BrokerAreaHeader_kylP0VE4Ee2Vgcav4Znc_wBranch.dart");
	}
}
