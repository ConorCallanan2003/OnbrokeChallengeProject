...
class DiscussionPanelContent_cA_45_CgVOkEe2KQc5QIsW97wBranch extends ContinueProcessRequest {
	
	
	Show_issue branch_Show_issue;
	
	DiscussionPanelContent_cA_45_CgVOkEe2KQc5QIsW97wBranch.forShow_issueBranch(
{		Data.Issue issue:null
	...
	DiscussionPanelContent_cA_45_CgVOkEe2KQc5QIsW97wBranch.forResolve_issueBranch(
{		Data.Issue issue:null
}	) {
	...
	DiscussionPanelContent_cA_45_CgVOkEe2KQc5QIsW97wBranch.forUnresolve_issueBranch(
{		Data.Issue issue:null
}	) {
	...
	DiscussionPanelContent_cA_45_CgVOkEe2KQc5QIsW97wBranch.forCreate_issueBranch(
	) {
	...
	Map<String,dynamic> toJSOG()
	{
		...
		throw new Exception("Exhaustive IF DiscussionPanelContent_cA_45_CgVOkEe2KQc5QIsW97wBranch.dart");
	}
}
