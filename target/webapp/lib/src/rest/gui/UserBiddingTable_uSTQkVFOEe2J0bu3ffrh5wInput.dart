...
class UserBiddingTable_uSTQkVFOEe2J0bu3ffrh5wInput extends UserInteractionResponse {
	
	DIMEList<Data.Bidding> biddings = new DIMEList<Data.Bidding>();
	
	UserBiddingTable_uSTQkVFOEe2J0bu3ffrh5wInput(Map<String,dynamic> map, Map<String,dynamic> cache)
	{
	...
	bool inpusChanged(UserBiddingTable_uSTQkVFOEe2J0bu3ffrh5wInput input) {
