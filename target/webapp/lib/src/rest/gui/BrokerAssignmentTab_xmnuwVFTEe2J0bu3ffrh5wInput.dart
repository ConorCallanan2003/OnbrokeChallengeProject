...
class BrokerAssignmentTab_xmnuwVFTEe2J0bu3ffrh5wInput extends UserInteractionResponse {
	
	DIMEList<Data.Offer> offers = new DIMEList<Data.Offer>();
	
	BrokerAssignmentTab_xmnuwVFTEe2J0bu3ffrh5wInput(Map<String,dynamic> map, Map<String,dynamic> cache)
	{
	...
	bool inpusChanged(BrokerAssignmentTab_xmnuwVFTEe2J0bu3ffrh5wInput input) {
