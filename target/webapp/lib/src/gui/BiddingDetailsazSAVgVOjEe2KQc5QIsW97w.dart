...
class BiddingDetailsazSAVgVOjEe2KQc5QIsW97w extends dime.DIMEComponent implements OnInit, OnDestroy, AfterViewInit {
  	...
  	List<DiscussionPanelContentacA_45_CgVOkEe2KQc5QIsW97w> componentSIBaC18vLFOlEe2KQc5QIsW97w;
	...
	void restartComponent() {
		...
		/// GUI DiscussionPanelContent
		if(componentSIBaC18vLFOlEe2KQc5QIsW97w!=null) {
			componentSIBaC18vLFOlEe2KQc5QIsW97w.forEach((n)=>n.restartComponent());
		}
		updateImageHash();
	}
	...
	void updateWithoutInputs({bool updateHidden:true}) {
		...
		componentSIBaC18vLFOlEe2KQc5QIsW97w.forEach((n)=>n.updateWithoutInputs());
		updateImageHash();
	}
