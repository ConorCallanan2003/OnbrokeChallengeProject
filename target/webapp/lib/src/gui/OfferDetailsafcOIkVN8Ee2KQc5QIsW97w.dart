...
class OfferDetailsafcOIkVN8Ee2KQc5QIsW97w extends dime.DIMEComponent implements OnInit, OnDestroy, AfterViewInit {
  	...
  	List<DiscussionPanelContentacA_45_CgVOkEe2KQc5QIsW97w> componentSIBa3jYyMXmiEe2ix_xiis0jnw;
	...
	void restartComponent() {
		...
		/// GUI DiscussionPanelContent
		if(componentSIBa3jYyMXmiEe2ix_xiis0jnw!=null) {
			componentSIBa3jYyMXmiEe2ix_xiis0jnw.forEach((n)=>n.restartComponent());
		}
		updateImageHash();
	}
	...
	void updateWithoutInputs({bool updateHidden:true}) {
		...
		componentSIBa3jYyMXmiEe2ix_xiis0jnw.forEach((n)=>n.updateWithoutInputs());
		updateImageHash();
	}
