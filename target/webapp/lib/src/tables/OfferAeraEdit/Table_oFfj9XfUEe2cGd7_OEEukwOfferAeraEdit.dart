...
@Component(
  selector: 'table-_oFfj9XfUEe2cGd7_OEEukw-offerAeraEdit',
  ...
  templateUrl: 'Table_oFfj9XfUEe2cGd7_OEEukwOfferAeraEdit.html',
  styles: const [
  ]
)
class Table_oFfj9XfUEe2cGd7_OEEukwOfferAeraEdit extends dime.DIMEComponent implements OnInit, AfterViewChecked {
	...
	//TABLE SORTING
	String current_oFfj9XfUEe2cGd7_OEEukwSortCol = "";
	
	// column Features
  	
	Table_oFfj9XfUEe2cGd7_OEEukwOfferAeraEdit(DIMEProcessService this.processService, TableDndService this.dndService, ElementRef this.elementRef, Router this.router,DomSanitizationService this.domSanitizationService,AbstractRoutes routes) : super(domSanitizationService,processService,routes)
	{
		restartComponent();
	}
	...
	void restartComponent() {
		...
		//TABLE SORTING
		current_oFfj9XfUEe2cGd7_OEEukwSortCol = "";
	...
	DIMEList table_oFfj9XfUEe2cGd7_OEEukwgetElements(DIMEList source) {
		DIMEList<Data.Feature>
		 table_oFfj9XfUEe2cGd7_OEEukwSource = new DIMEList();
		if(source==null) {
			return table_oFfj9XfUEe2cGd7_OEEukwSource;
		}
		table_oFfj9XfUEe2cGd7_OEEukwSource.addAll(source.where((element) {
		            return (
			true);
		        }));
			    return table_oFfj9XfUEe2cGd7_OEEukwSource;
	...
	String table_oFfj9XfUEe2cGd7_OEEukwIsSorted(String colId) {
	...
	String tableValue_oFfkEnfUEe2cGd7_OEEukwProvider(dynamic value) {
