...
@Component(
  selector: 'table-_a_RZAV7pEe2MjMOCwlD7jg-biddingAreaEdit',
  ...
  templateUrl: 'Table_a_RZAV7pEe2MjMOCwlD7jgBiddingAreaEdit.html',
  styles: const [
  ]
)
class Table_a_RZAV7pEe2MjMOCwlD7jgBiddingAreaEdit extends dime.DIMEComponent implements OnInit, AfterViewChecked {
	...
	//TABLE SORTING
	String current_a_RZAV7pEe2MjMOCwlD7jgSortCol = "";
	
	// column Preferences
  	
	Table_a_RZAV7pEe2MjMOCwlD7jgBiddingAreaEdit(DIMEProcessService this.processService, TableDndService this.dndService, ElementRef this.elementRef, Router this.router,DomSanitizationService this.domSanitizationService,AbstractRoutes routes) : super(domSanitizationService,processService,routes)
	{
		restartComponent();
	}
	...
	void restartComponent() {
		...
		//TABLE SORTING
		current_a_RZAV7pEe2MjMOCwlD7jgSortCol = "";
	...
	DIMEList table_a_RZAV7pEe2MjMOCwlD7jggetElements(DIMEList source) {
		DIMEList<Data.Feature>
		 table_a_RZAV7pEe2MjMOCwlD7jgSource = new DIMEList();
		if(source==null) {
			return table_a_RZAV7pEe2MjMOCwlD7jgSource;
		}
		table_a_RZAV7pEe2MjMOCwlD7jgSource.addAll(source.where((element) {
		            return (
			true);
		        }));
			    return table_a_RZAV7pEe2MjMOCwlD7jgSource;
	...
	String table_a_RZAV7pEe2MjMOCwlD7jgIsSorted(String colId) {
	...
	String tableValue_bfZqkV7pEe2MjMOCwlD7jgProvider(dynamic value) {
