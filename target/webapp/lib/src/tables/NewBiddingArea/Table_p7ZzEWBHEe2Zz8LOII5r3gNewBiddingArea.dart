...
@Component(
  selector: 'table-_p7ZzEWBHEe2Zz8LOII5r3g-newBiddingArea',
  ...
  templateUrl: 'Table_p7ZzEWBHEe2Zz8LOII5r3gNewBiddingArea.html',
  styles: const [
  ]
)
class Table_p7ZzEWBHEe2Zz8LOII5r3gNewBiddingArea extends dime.DIMEComponent implements OnInit, AfterViewChecked {
	...
	//TABLE SORTING
	String current_p7ZzEWBHEe2Zz8LOII5r3gSortCol = "";
	
	// column Features
  	
	Table_p7ZzEWBHEe2Zz8LOII5r3gNewBiddingArea(DIMEProcessService this.processService, TableDndService this.dndService, ElementRef this.elementRef, Router this.router,DomSanitizationService this.domSanitizationService,AbstractRoutes routes) : super(domSanitizationService,processService,routes)
	{
		restartComponent();
	}
	...
	void restartComponent() {
		...
		//TABLE SORTING
		current_p7ZzEWBHEe2Zz8LOII5r3gSortCol = "";
	...
	DIMEList table_p7ZzEWBHEe2Zz8LOII5r3ggetElements(DIMEList source) {
		DIMEList<Data.Feature>
		 table_p7ZzEWBHEe2Zz8LOII5r3gSource = new DIMEList();
		if(source==null) {
			return table_p7ZzEWBHEe2Zz8LOII5r3gSource;
		}
		table_p7ZzEWBHEe2Zz8LOII5r3gSource.addAll(source.where((element) {
		            return (
			true);
		        }));
			    return table_p7ZzEWBHEe2Zz8LOII5r3gSource;
	...
	String table_p7ZzEWBHEe2Zz8LOII5r3gIsSorted(String colId) {
	...
	String tableValue_qadGkWBHEe2Zz8LOII5r3gProvider(dynamic value) {
