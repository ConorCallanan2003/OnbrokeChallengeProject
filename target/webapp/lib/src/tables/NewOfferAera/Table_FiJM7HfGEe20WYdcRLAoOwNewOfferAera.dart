...
// table in GUI model newOfferAera
...
@Component(
  selector: 'table-_FiJM7HfGEe20WYdcRLAoOw-newOfferAera',
  ...
  templateUrl: 'Table_FiJM7HfGEe20WYdcRLAoOwNewOfferAera.html',
  styles: const [
  ]
)
class Table_FiJM7HfGEe20WYdcRLAoOwNewOfferAera extends dime.DIMEComponent implements OnInit, AfterViewChecked {
	...
	//TABLE SORTING
	String current_FiJM7HfGEe20WYdcRLAoOwSortCol = "";
	
	// column Features
  	
	Table_FiJM7HfGEe20WYdcRLAoOwNewOfferAera(DIMEProcessService this.processService, TableDndService this.dndService, ElementRef this.elementRef, Router this.router,DomSanitizationService this.domSanitizationService,AbstractRoutes routes) : super(domSanitizationService,processService,routes)
	{
		restartComponent();
	}
	...
	void restartComponent() {
		...
		//TABLE SORTING
		current_FiJM7HfGEe20WYdcRLAoOwSortCol = "";
	...
	DIMEList table_FiJM7HfGEe20WYdcRLAoOwgetElements(DIMEList source) {
		DIMEList<Data.Feature>
		 table_FiJM7HfGEe20WYdcRLAoOwSource = new DIMEList();
		if(source==null) {
			return table_FiJM7HfGEe20WYdcRLAoOwSource;
		}
		table_FiJM7HfGEe20WYdcRLAoOwSource.addAll(source.where((element) {
		            return (
			true);
		        }));
			    return table_FiJM7HfGEe20WYdcRLAoOwSource;
	...
	String table_FiJM7HfGEe20WYdcRLAoOwIsSorted(String colId) {
	...
	void choiceClicked(dynamic value)
	{
		...
		int index = this.initOnDemandselectedFeature().indexOf(value);
		if (index > -1) {
			this.initOnDemandselectedFeature().removeAt(index);
		}
		else {
			this.initOnDemandselectedFeature().add(value);
		}
	}
	
	/// getter for the value of the Features column
	String tableValue_FiKa83fGEe20WYdcRLAoOwProvider(dynamic value) {
