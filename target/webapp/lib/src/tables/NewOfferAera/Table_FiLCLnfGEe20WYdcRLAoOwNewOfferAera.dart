...
@Component(
  selector: 'table-_FiLCLnfGEe20WYdcRLAoOw-newOfferAera',
  ...
  templateUrl: 'Table_FiLCLnfGEe20WYdcRLAoOwNewOfferAera.html',
  styles: const [
  ]
)
class Table_FiLCLnfGEe20WYdcRLAoOwNewOfferAera extends dime.DIMEComponent implements OnInit, AfterViewChecked {
	...
	//TABLE SORTING
	String current_FiLCLnfGEe20WYdcRLAoOwSortCol = "";
	
	// column Preferences
  	
	Table_FiLCLnfGEe20WYdcRLAoOwNewOfferAera(DIMEProcessService this.processService, TableDndService this.dndService, ElementRef this.elementRef, Router this.router,DomSanitizationService this.domSanitizationService,AbstractRoutes routes) : super(domSanitizationService,processService,routes)
	{
		restartComponent();
	}
	...
	void restartComponent() {
		...
		//TABLE SORTING
		current_FiLCLnfGEe20WYdcRLAoOwSortCol = "";
	...
	DIMEList table_FiLCLnfGEe20WYdcRLAoOwgetElements(DIMEList source) {
		DIMEList<Data.Feature>
		 table_FiLCLnfGEe20WYdcRLAoOwSource = new DIMEList();
		if(source==null) {
			return table_FiLCLnfGEe20WYdcRLAoOwSource;
		}
		table_FiLCLnfGEe20WYdcRLAoOwSource.addAll(source.where((element) {
		            return (
			true);
		        }));
			    return table_FiLCLnfGEe20WYdcRLAoOwSource;
	...
	String table_FiLCLnfGEe20WYdcRLAoOwIsSorted(String colId) {
	...
	String tableValue_FiLCS3fGEe20WYdcRLAoOwProvider(dynamic value) {
