	...
	User({core.Map<core.String,core.dynamic> cache, jsog}) {
		...
		// from jsog
			...
			if (jsog.containsKey("dywaSwitchedTo")) {
				...
				if(jsogObj != null) {
					User valueayznk4W3EEe28ArSCN9G57A;
					...
					if (cache.containsKey(jsogId)) {
						valueayznk4W3EEe28ArSCN9G57A = cache[jsogId];
					}
					else {
						if (jsogObj != null) {
							if (jsogObj['dywaRuntimeType'] == "de.ls5.dywa.generated.rest.types.UserImpl") {
								valueayznk4W3EEe28ArSCN9G57A = new User(cache: cache, jsog: jsogObj);
							}
							else {
								valueayznk4W3EEe28ArSCN9G57A = new User(cache: cache,jsog: jsogObj);
							}
					...
					this._dywaSwitchedTo = valueayznk4W3EEe28ArSCN9G57A;
				}
			}
	...
	UserRole({core.Map<core.String,core.dynamic> cache, jsog}) {
		...
		// from jsog
			...
			if (jsog.containsKey("dywaDisplayName")) {
				...
				if(jsogObj != null) {
					core.String valueayzwHwW3EEe28ArSCN9G57A;
					
					if(jsogObj!=null){
					valueayzwHwW3EEe28ArSCN9G57A = jsogObj.toString();
					}
					this._dywaDisplayName = valueayzwHwW3EEe28ArSCN9G57A;
				}
				else {
					this._dywaDisplayName = null;
				}
	...
	DecisionState({core.Map<core.String,core.dynamic> cache, jsog}) {
		...
		// from jsog
			...
			if (jsog.containsKey("dywaDisplayName")) {
				core.String jsogObj = jsog["dywaDisplayName"];
				if(jsogObj != null) {
					core.String valueayz9jIW3EEe28ArSCN9G57A;
					
					if(jsogObj!=null){
					valueayz9jIW3EEe28ArSCN9G57A = jsogObj.toString();
					}
					this._dywaDisplayName = valueayz9jIW3EEe28ArSCN9G57A;
				}
				else {
					this._dywaDisplayName = null;
				}
	...
	Priority({core.Map<core.String,core.dynamic> cache, jsog}) {
		...
		// from jsog
			...
			if (jsog.containsKey("dywaDisplayName")) {
				core.String jsogObj = jsog["dywaDisplayName"];
				if(jsogObj != null) {
					core.String valueay0K_45_gW3EEe28ArSCN9G57A;
					
					if(jsogObj!=null){
					valueay0K_45_gW3EEe28ArSCN9G57A = jsogObj.toString();
					}
					this._dywaDisplayName = valueay0K_45_gW3EEe28ArSCN9G57A;
				}
				else {
					this._dywaDisplayName = null;
				}
	...
	IssueState({core.Map<core.String,core.dynamic> cache, jsog}) {
		...
		// from jsog
			...
			if (jsog.containsKey("dywaDisplayName")) {
				core.String jsogObj = jsog["dywaDisplayName"];
				if(jsogObj != null) {
					core.String valueay0ZA8W3EEe28ArSCN9G57A;
					
					if(jsogObj!=null){
					valueay0ZA8W3EEe28ArSCN9G57A = jsogObj.toString();
					}
					this._dywaDisplayName = valueay0ZA8W3EEe28ArSCN9G57A;
				}
				else {
					this._dywaDisplayName = null;
				}
