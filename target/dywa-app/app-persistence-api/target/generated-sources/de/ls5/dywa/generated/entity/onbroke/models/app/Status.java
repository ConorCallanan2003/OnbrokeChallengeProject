...
public enum Status implements de.ls5.dywa.generated.util.Identifiable, de.ls5.dywa.generated.entity.onbroke.models.app.StatusInterface {
	open(88L), closed(89L);
	
	private final long id;
	private StatusInterface internalDelegate;
	...
	public de.ls5.dywa.generated.entity.onbroke.models.app.Status getopen() {
		loadOrRefresh();
		return this.internalDelegate != null ? this.internalDelegate.getopen() : null;
	}
	
	public void setopen(de.ls5.dywa.generated.entity.onbroke.models.app.Status newValue) {
		loadOrRefresh();
		if (this.internalDelegate != null) {
			this.internalDelegate.setopen(newValue);
		}
	}

	public de.ls5.dywa.generated.entity.onbroke.models.app.Status getclosed() {
		loadOrRefresh();
		return this.internalDelegate != null ? this.internalDelegate.getclosed() : null;
	}
	
	public void setclosed(de.ls5.dywa.generated.entity.onbroke.models.app.Status newValue) {
		loadOrRefresh();
		if (this.internalDelegate != null) {
			this.internalDelegate.setclosed(newValue);
		}
	}
	...
	private void loadOrRefresh() {
		...
		if (this.internalDelegate == null || !em.contains(this.internalDelegate)) {
			javax.persistence.TypedQuery<de.ls5.dywa.generated.entity.onbroke.models.app.StatusInterface> query = em.createQuery(
				"SELECT ent " +
				"FROM de.ls5.dywa.generated.util.EnumMapping map " +
					"JOIN de.ls5.dywa.generated.entity.onbroke.models.app.StatusEntity ent " +
					"ON (map.objectId = ent.id_) " +
				"WHERE map.enumId = :id",
				de.ls5.dywa.generated.entity.onbroke.models.app.StatusInterface.class);
	...
	<T extends StatusInterface> T getEntityAs(Class<T> clazz) {
		loadOrRefresh();
		return (T) this.internalDelegate;
	}
	
	public static Status forId(long id) {
		if (id == 88) {
			return Status.open;
		} else 
		if (id == 89) {
