...
public class EditAssignmentGUIResumer extends info.scce.dime.process.GUIResumer {
		...
		checkAuthentication(output.getCallStack(),"_mOjJMVuZEe2C-dvY0XUmpA/Assign");
			...
			if (output.getThisBidding().getDywaId() == info.scce.dime.util.Constants.DYWA_ID_CREATE_NEW) {
				if(output.getThisBidding() instanceof de.ls5.dywa.generated.rest.types.Bidding) {
					...
					BiddingREST.update_EditAssignmentBiddingSelectivex1x10x10x18x18_mOjJMVuZEe2C__HYPHEN_MINUS__dvY0XUmpA((de.ls5.dywa.generated.rest.types.Bidding)output.getThisBidding());
			...
			// transient object
				...
				if(output.getThisBidding() instanceof de.ls5.dywa.generated.rest.types.Bidding) {
					...
					//update_EditAssignmentBiddingSelectivex1x10x10x18x18_mOjJMVuZEe2C__HYPHEN_MINUS__dvY0XUmpA
					BiddingREST.update_EditAssignmentBiddingSelectivex1x10x10x18x18_mOjJMVuZEe2C__HYPHEN_MINUS__dvY0XUmpA((de.ls5.dywa.generated.rest.types.Bidding)output.getThisBidding(), transientObject);
					thisBidding = (de.ls5.dywa.generated.entity.onbroke.models.app.Bidding
					) transientObject;
				}
		 else { throw new java.lang.IllegalArgumentException("Unexpected type " + output.getThisBidding().getClass()); }	}
	...
	@javax.ws.rs.Produces(javax.ws.rs.core.MediaType.APPLICATION_JSON)
	@javax.ws.rs.Consumes(javax.ws.rs.core.MediaType.APPLICATION_JSON)
	public javax.ws.rs.core.Response continueCancel_EditBranch(info.scce.dime.rest.gui.model._bWPu1FLZEe2djpkPxa2Z3QBranch output) {
