...
public final class ShowCreateUser_EP__HYPHEN_MINUS__IgV3WEe2t19MJLPzxmg implements DIMEProcess {
	...
	public SIB_ID execute_u__HYPHEN_MINUS__mRAWEUEe2Fx80Lw9BAUQ(final Context ctx) {
		...
		List<de.ls5.dywa.generated.entity.onbroke.models.app.UserRole> value29 = result;
		if (value29 != null) { // prevent null in lists
		ctx.Retrieve_from_UserRoleSuccessRetrieved_u__HYPHEN_MINUS__4k4WEUEe2Fx80Lw9BAUQ = new ArrayList<de.ls5.dywa.generated.entity.onbroke.models.app.UserRole>(value29);
		}
		if (result.isEmpty()) {
			// branch 'none found'
			return SIB_ID._8GdY0V3XEe2t19MJLPzxmg;
