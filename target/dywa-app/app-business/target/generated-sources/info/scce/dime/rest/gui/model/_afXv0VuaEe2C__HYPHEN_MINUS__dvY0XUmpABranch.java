		...
		public class _afXv0VuaEe2C__HYPHEN_MINUS__dvY0XUmpABranch{
			...
			@com.fasterxml.jackson.annotation.JsonProperty("thisBidding")
			...
			@com.fasterxml.jackson.annotation.JsonProperty("thisBidding")
			public void setThisBidding(de.ls5.dywa.generated.rest.types.Bidding
			 thisBidding) {
				this.thisBidding = thisBidding;
			}
		}
