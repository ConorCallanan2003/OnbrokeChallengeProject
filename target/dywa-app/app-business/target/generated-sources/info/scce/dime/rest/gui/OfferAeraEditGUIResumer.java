...
@javax.ws.rs.Path("/continue/_kAL7QXfUEe2cGd7_OEEukw")
public class OfferAeraEditGUIResumer extends info.scce.dime.process.GUIResumer {
	...
	public javax.ws.rs.core.Response continueSubmitBranch(info.scce.dime.rest.gui.model._b9LjoVnDEe2zb__HYPHEN_MINUS__oDKccEjg_INTERNALBranch output) {
		...
		checkAuthentication(output.getCallStack(),"_kAL7QXfUEe2cGd7_OEEukw/Submit");
			...
			if (output.getSelectedFeatures() != null) {
				...
				if (o.getDywaId() == info.scce.dime.util.Constants.DYWA_ID_CREATE_NEW) {
					if(o instanceof de.ls5.dywa.generated.rest.types.Feature) {
						...
						//update_OfferAeraEditFeatureSelectivex2_kAL7QXfUEe2cGd7_OEEukw
			...
			if (output.getSelectedPreferences() != null) {
				...
				if (o.getDywaId() == info.scce.dime.util.Constants.DYWA_ID_CREATE_NEW) {
					if(o instanceof de.ls5.dywa.generated.rest.types.Feature) {
						...
						//update_OfferAeraEditFeatureSelectivex4_kAL7QXfUEe2cGd7_OEEukw
						FeatureREST.update_NewOfferAeraFeatureSelectivex4_Ag9K4HfGEe20WYdcRLAoOw((de.ls5.dywa.generated.rest.types.Feature)o);
		...
		final info.scce.dime.gui.onbroke.models.areas.user.newoffer.offeraeraedit.OfferAeraEdit_kAL7QXfUEe2cGd7_OEEukwResult.gui__zo1__HYPHEN_MINUS__03hbEe2mVL2cgUAW0ASubmitReturn guiReturn = new info.scce.dime.gui.onbroke.models.areas.user.newoffer.offeraeraedit.OfferAeraEdit_kAL7QXfUEe2cGd7_OEEukwResult.gui__zo1__HYPHEN_MINUS__03hbEe2mVL2cgUAW0ASubmitReturn();
		...
		final info.scce.dime.gui.onbroke.models.areas.user.newoffer.offeraeraedit.OfferAeraEdit_kAL7QXfUEe2cGd7_OEEukwResult guiResult = 
		new info.scce.dime.gui.onbroke.models.areas.user.newoffer.offeraeraedit.OfferAeraEdit_kAL7QXfUEe2cGd7_OEEukwResult("Submit", guiReturn);
		if(!"_kAL7QXfUEe2cGd7_OEEukw".equals(output.getCallStack().getCallFrames().get(output.getCallStack().getCallFrames().size()-1).getPointer().split(":")[2])){
	...
	public javax.ws.rs.core.Response continueCreate_new_featureBranch(info.scce.dime.rest.gui.model._mSh2L1LZEe2djpkPxa2Z3QBranch output) {
		...
		checkAuthentication(output.getCallStack(),"_kAL7QXfUEe2cGd7_OEEukw/Create_new_feature");
		
		
		final info.scce.dime.gui.onbroke.models.areas.user.newoffer.offeraeraedit.OfferAeraEdit_kAL7QXfUEe2cGd7_OEEukwResult guiResult = 
		new info.scce.dime.gui.onbroke.models.areas.user.newoffer.offeraeraedit.OfferAeraEdit_kAL7QXfUEe2cGd7_OEEukwResult("Create_new_feature");
		if(!"_kAL7QXfUEe2cGd7_OEEukw".equals(output.getCallStack().getCallFrames().get(output.getCallStack().getCallFrames().size()-1).getPointer().split(":")[2])){
					output.getCallStack().getCallFrames().get(output.getCallStack().getCallFrames().size()-1).setPointer(output.getCallStack().getCallFrames().get(output.getCallStack().getCallFrames().size()-1).getMajorGUI());
		}
		if(!output.getCallStack().getCallFrames().isEmpty()) {
	...
	public javax.ws.rs.core.Response continueCreate_new_preferenceBranch(info.scce.dime.rest.gui.model._mSh2L1LZEe2djpkPxa2Z3QBranch output) {
		...
		checkAuthentication(output.getCallStack(),"_kAL7QXfUEe2cGd7_OEEukw/Create_new_preference");
		
		
		final info.scce.dime.gui.onbroke.models.areas.user.newoffer.offeraeraedit.OfferAeraEdit_kAL7QXfUEe2cGd7_OEEukwResult guiResult = 
		new info.scce.dime.gui.onbroke.models.areas.user.newoffer.offeraeraedit.OfferAeraEdit_kAL7QXfUEe2cGd7_OEEukwResult("Create_new_preference");
		if(!"_kAL7QXfUEe2cGd7_OEEukw".equals(output.getCallStack().getCallFrames().get(output.getCallStack().getCallFrames().size()-1).getPointer().split(":")[2])){
					output.getCallStack().getCallFrames().get(output.getCallStack().getCallFrames().size()-1).setPointer(output.getCallStack().getCallFrames().get(output.getCallStack().getCallFrames().size()-1).getMajorGUI());
		}
		if(!output.getCallStack().getCallFrames().isEmpty()) {
	...
	public javax.ws.rs.core.Response continueCancelBranch(info.scce.dime.rest.gui.model._mSh2L1LZEe2djpkPxa2Z3QBranch output) {
		...
		checkAuthentication(output.getCallStack(),"_kAL7QXfUEe2cGd7_OEEukw/Cancel");
		
		
		final info.scce.dime.gui.onbroke.models.areas.user.newoffer.offeraeraedit.OfferAeraEdit_kAL7QXfUEe2cGd7_OEEukwResult guiResult = 
		new info.scce.dime.gui.onbroke.models.areas.user.newoffer.offeraeraedit.OfferAeraEdit_kAL7QXfUEe2cGd7_OEEukwResult("Cancel");
		if(!"_kAL7QXfUEe2cGd7_OEEukw".equals(output.getCallStack().getCallFrames().get(output.getCallStack().getCallFrames().size()-1).getPointer().split(":")[2])){
					output.getCallStack().getCallFrames().get(output.getCallStack().getCallFrames().size()-1).setPointer(output.getCallStack().getCallFrames().get(output.getCallStack().getCallFrames().size()-1).getMajorGUI());
		}
		if(!output.getCallStack().getCallFrames().isEmpty()) {
