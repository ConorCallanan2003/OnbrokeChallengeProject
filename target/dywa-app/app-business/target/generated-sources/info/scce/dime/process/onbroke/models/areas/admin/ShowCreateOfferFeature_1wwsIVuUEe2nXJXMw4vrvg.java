...
public final class ShowCreateOfferFeature_1wwsIVuUEe2nXJXMw4vrvg implements DIMEProcess {
	...
	public SIB_ID execute_bshIoWGeEe2SIeIc0TVXOQ(final Context ctx) {
		...
		List<de.ls5.dywa.generated.entity.onbroke.models.app.Priority> value26 = result;
		if (value26 != null) { // prevent null in lists
		ctx.Retrieve_from_PrioritySuccessRetrieved_bs__HYPHEN_MINUS__boWGeEe2SIeIc0TVXOQ = new ArrayList<de.ls5.dywa.generated.entity.onbroke.models.app.Priority>(value26);
		}
		if (result.isEmpty()) {
			// branch 'none found'
			return SIB_ID._avsdEVuVEe2nXJXMw4vrvg;
