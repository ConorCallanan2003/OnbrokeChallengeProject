...
@javax.ws.rs.Path("/continue/_Ag9K4HfGEe20WYdcRLAoOw")
public class newOfferAeraGUIResumer extends info.scce.dime.process.GUIResumer {
	...
	public javax.ws.rs.core.Response continueSubmitBranch(info.scce.dime.rest.gui.model._FiMQXnfGEe20WYdcRLAoOwBranch output) {
		...
		checkAuthentication(output.getCallStack(),"_Ag9K4HfGEe20WYdcRLAoOw/Submit");
			...
			if (output.getSelectedFeature() != null) {
				...
				if (o.getDywaId() == info.scce.dime.util.Constants.DYWA_ID_CREATE_NEW) {
					if(o instanceof de.ls5.dywa.generated.rest.types.Feature) {
						...
						//update_NewOfferAeraFeatureSelectivex4_Ag9K4HfGEe20WYdcRLAoOw
			...
			if (output.getSelectedPreferences() != null) {
				...
				if (o.getDywaId() == info.scce.dime.util.Constants.DYWA_ID_CREATE_NEW) {
					if(o instanceof de.ls5.dywa.generated.rest.types.Feature) {
						...
						//update_NewOfferAeraFeatureSelectivex5_Ag9K4HfGEe20WYdcRLAoOw
						FeatureREST.update_NewOfferAeraFeatureSelectivex4_Ag9K4HfGEe20WYdcRLAoOw((de.ls5.dywa.generated.rest.types.Feature)o);
		...
		final info.scce.dime.gui.onbroke.models.areas.user.newoffer.newofferaera.NewOfferAera_Ag9K4HfGEe20WYdcRLAoOwResult.gui__FiMQXnfGEe20WYdcRLAoOwSubmitReturn guiReturn = new info.scce.dime.gui.onbroke.models.areas.user.newoffer.newofferaera.NewOfferAera_Ag9K4HfGEe20WYdcRLAoOwResult.gui__FiMQXnfGEe20WYdcRLAoOwSubmitReturn();
		...
		final info.scce.dime.gui.onbroke.models.areas.user.newoffer.newofferaera.NewOfferAera_Ag9K4HfGEe20WYdcRLAoOwResult guiResult = 
		new info.scce.dime.gui.onbroke.models.areas.user.newoffer.newofferaera.NewOfferAera_Ag9K4HfGEe20WYdcRLAoOwResult("Submit", guiReturn);
		if(!"_Ag9K4HfGEe20WYdcRLAoOw".equals(output.getCallStack().getCallFrames().get(output.getCallStack().getCallFrames().size()-1).getPointer().split(":")[2])){
	...
	public javax.ws.rs.core.Response continueCancelBranch(info.scce.dime.rest.gui.model._mSh2L1LZEe2djpkPxa2Z3QBranch output) {
		...
		checkAuthentication(output.getCallStack(),"_Ag9K4HfGEe20WYdcRLAoOw/Cancel");
		
		
		final info.scce.dime.gui.onbroke.models.areas.user.newoffer.newofferaera.NewOfferAera_Ag9K4HfGEe20WYdcRLAoOwResult guiResult = 
		new info.scce.dime.gui.onbroke.models.areas.user.newoffer.newofferaera.NewOfferAera_Ag9K4HfGEe20WYdcRLAoOwResult("Cancel");
		if(!"_Ag9K4HfGEe20WYdcRLAoOw".equals(output.getCallStack().getCallFrames().get(output.getCallStack().getCallFrames().size()-1).getPointer().split(":")[2])){
					output.getCallStack().getCallFrames().get(output.getCallStack().getCallFrames().size()-1).setPointer(output.getCallStack().getCallFrames().get(output.getCallStack().getCallFrames().size()-1).getMajorGUI());
		}
		if(!output.getCallStack().getCallFrames().isEmpty()) {
	...
	public javax.ws.rs.core.Response continueCreate_New_PreferenceBranch(info.scce.dime.rest.gui.model._mSh2L1LZEe2djpkPxa2Z3QBranch output) {
		...
		checkAuthentication(output.getCallStack(),"_Ag9K4HfGEe20WYdcRLAoOw/Create_New_Preference");
		
		
		final info.scce.dime.gui.onbroke.models.areas.user.newoffer.newofferaera.NewOfferAera_Ag9K4HfGEe20WYdcRLAoOwResult guiResult = 
		new info.scce.dime.gui.onbroke.models.areas.user.newoffer.newofferaera.NewOfferAera_Ag9K4HfGEe20WYdcRLAoOwResult("Create_New_Preference");
		if(!"_Ag9K4HfGEe20WYdcRLAoOw".equals(output.getCallStack().getCallFrames().get(output.getCallStack().getCallFrames().size()-1).getPointer().split(":")[2])){
					output.getCallStack().getCallFrames().get(output.getCallStack().getCallFrames().size()-1).setPointer(output.getCallStack().getCallFrames().get(output.getCallStack().getCallFrames().size()-1).getMajorGUI());
		}
		if(!output.getCallStack().getCallFrames().isEmpty()) {
	...
	public javax.ws.rs.core.Response continueCreate_New_FeatureBranch(info.scce.dime.rest.gui.model._mSh2L1LZEe2djpkPxa2Z3QBranch output) {
		...
		checkAuthentication(output.getCallStack(),"_Ag9K4HfGEe20WYdcRLAoOw/Create_New_Feature");
		
		
		final info.scce.dime.gui.onbroke.models.areas.user.newoffer.newofferaera.NewOfferAera_Ag9K4HfGEe20WYdcRLAoOwResult guiResult = 
		new info.scce.dime.gui.onbroke.models.areas.user.newoffer.newofferaera.NewOfferAera_Ag9K4HfGEe20WYdcRLAoOwResult("Create_New_Feature");
		if(!"_Ag9K4HfGEe20WYdcRLAoOw".equals(output.getCallStack().getCallFrames().get(output.getCallStack().getCallFrames().size()-1).getPointer().split(":")[2])){
					output.getCallStack().getCallFrames().get(output.getCallStack().getCallFrames().size()-1).setPointer(output.getCallStack().getCallFrames().get(output.getCallStack().getCallFrames().size()-1).getMajorGUI());
		}
		if(!output.getCallStack().getCallFrames().isEmpty()) {
