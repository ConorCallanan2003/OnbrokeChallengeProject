...
public final class ShowBrokerArea_zgnP4FFLEe2Vgcav4Znc_w implements DIMEProcess {
	...
	public SIB_ID continue_fElJMVFOEe2J0bu3ffrh5w(Context ctx, Object guiResult) {
		...
		if ("Auto_Assign".equals(result.getBranchName())) {
			...
			List<de.ls5.dywa.generated.entity.onbroke.models.app.Offer> value31 = (List<de.ls5.dywa.generated.entity.onbroke.models.app.Offer>)result.getgui__oi368V94Ee2pr7wspri7wwAuto_AssignReturn().getApprovedOffers();
			if (value31 != null) { // prevent null in lists
			ctx.BrokerAreaAuto_AssignApprovedOffers_BphAkWEsEe22faBh7MAS9A = new ArrayList<de.ls5.dywa.generated.entity.onbroke.models.app.Offer>(value31);
			}
			}
			// branch 'Auto Assign'
	...
	public SIB_ID execute_ffvSAVGMEe2J0bu3ffrh5w(final Context ctx) {
		...
		case "success": {
			List<de.ls5.dywa.generated.entity.onbroke.models.app.Offer> value32 = result.getSuccessReturn().getApprovedOffers();
			if (value32 != null) { // prevent null in lists
			ctx.InitBrokerAreaSuccessApprovedOffers_fgFQQFGMEe2J0bu3ffrh5w = new ArrayList<de.ls5.dywa.generated.entity.onbroke.models.app.Offer>(value32);
			}
			List<de.ls5.dywa.generated.entity.onbroke.models.app.Offer> value33 = result.getSuccessReturn().getOffers();
			if (value33 != null) { // prevent null in lists
			ctx.InitBrokerAreaSuccessOffers_fgOaMVGMEe2J0bu3ffrh5w = new ArrayList<de.ls5.dywa.generated.entity.onbroke.models.app.Offer>(value33);
			}
			List<de.ls5.dywa.generated.entity.onbroke.models.app.Bidding> value34 = result.getSuccessReturn().getBiddings();
			if (value34 != null) { // prevent null in lists
			ctx.InitBrokerAreaSuccessBiddings_fgWWAVGMEe2J0bu3ffrh5w = new ArrayList<de.ls5.dywa.generated.entity.onbroke.models.app.Bidding>(value34);
			}
			// branch 'success'
			return SIB_ID._fElJMVFOEe2J0bu3ffrh5w;
		}
