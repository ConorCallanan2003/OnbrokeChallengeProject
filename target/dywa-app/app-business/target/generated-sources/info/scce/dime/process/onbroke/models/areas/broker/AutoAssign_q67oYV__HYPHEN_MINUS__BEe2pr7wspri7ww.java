...
public final class AutoAssign_q67oYV__HYPHEN_MINUS__BEe2pr7wspri7ww implements DIMEProcess {
	...
	public static class Context implements DIMEProcessContext {
		...
		private List<de.ls5.dywa.generated.entity.onbroke.models.app.Offer> filterUnassignedSuccessOutput_aT6IoWEqEe22fKBh7MAS9A = new ArrayList<>();
	...
	private Context createContext(List<de.ls5.dywa.generated.entity.onbroke.models.app.Offer> offer) {
		...
		// store inputs
		List<de.ls5.dywa.generated.entity.onbroke.models.app.Offer> value31 = offer;
		if (value31 != null) { // prevent null in lists
		ctx.startOffer_6kXi0WErEe22faBh7MAS9A = new ArrayList<de.ls5.dywa.generated.entity.onbroke.models.app.Offer>(value31);
		}
	...
	public AutoAssign_q67oYV__HYPHEN_MINUS__BEe2pr7wspri7wwResult execute(boolean isAuthenticationRequired,List<de.ls5.dywa.generated.entity.onbroke.models.app.Offer> offer) {
		...
		return executeInternal(ctx, SIB_ID._aTnNsWEqEe22fKBh7MAS9A);
	}
	...
	private AutoAssign_q67oYV__HYPHEN_MINUS__BEe2pr7wspri7wwResult executeInternal(final Context ctx, final SIB_ID id) {
		...
		while (true) {
			switch (curr) {
				...
				case _aTnNsWEqEe22fKBh7MAS9A: {
					curr = execute_aTnNsWEqEe22fKBh7MAS9A(ctx);
					break;
				}
				default: {
	...
	public SIB_ID execute_mqiLQWEjEe2Vwqqo0dxUZA(final Context ctx) {
		...
		List<de.ls5.dywa.generated.entity.onbroke.models.app.Offer> list = ctx.filterUnassignedSuccessOutput_aT6IoWEqEe22fKBh7MAS9A;
		if(list != null && pos < list.size()) {
			ctx.offer = ctx.filterUnassignedSuccessOutput_aT6IoWEqEe22fKBh7MAS9A.get(pos);
			// branch 'next'
	...
	// container for atomic SIB 'filterUnassigned'.
	public SIB_ID execute_aTnNsWEqEe22fKBh7MAS9A(final Context ctx) {
		try {
			final List<de.ls5.dywa.generated.entity.onbroke.models.app.Offer> result = info.scce.dime.app.onbroke.OnbrokeNative.filterUnassigned(ctx.startOffer_6kXi0WErEe22faBh7MAS9A);
			List<de.ls5.dywa.generated.entity.onbroke.models.app.Offer> value32 = result;
			if (value32 != null) { // prevent null in lists
			ctx.filterUnassignedSuccessOutput_aT6IoWEqEe22fKBh7MAS9A = new ArrayList<de.ls5.dywa.generated.entity.onbroke.models.app.Offer>(value32);
			}
		}
		catch (Exception e) {
			e.printStackTrace();
			// branch 'failure'
			throw new IllegalStateException("SIB 'filterUnassigned' has no successor defined for branch 'failure'");
		}
		// branch 'success'
		return SIB_ID._mqiLQWEjEe2Vwqqo0dxUZA;
	}
