...
public final class ShowEditUser_p4xdMWBEEe2RjrkbQARhdg implements DIMEProcess {
		...
		
		{
			...
			if (obj != null) {
				if (obj.getDywaId() > info.scce.dime.util.Constants.DYWA_ID_TRANSIENT) {
					...
					restTO = inputsUserREST.read_EditAssignmentUserSelectivex1x10x10x18x18x2x2_mOjJMVuZEe2C__HYPHEN_MINUS__dvY0XUmpA(obj.getDywaId());
				}
				else {
					...
					de.ls5.dywa.generated.rest.types.EditAssignmentUserSelectivex1x10x10x18x18x2x2_mOjJMVuZEe2C__HYPHEN_MINUS__dvY0XUmpA.copy(obj, restTO, objectCache);
				}
				result = restTO;
			}
	...
	public SIB_ID execute_58W_EWEUEe2Fx80Lw9BAUQ(final Context ctx) {
		...
		List<de.ls5.dywa.generated.entity.onbroke.models.app.UserRole> value9 = result;
		if (value9 != null) { // prevent null in lists
		ctx.Retrieve_from_UserRoleSuccessRetrieved_58hXIWEUEe2Fx80Lw9BAUQ = new ArrayList<de.ls5.dywa.generated.entity.onbroke.models.app.UserRole>(value9);
		}
		if (result.isEmpty()) {
			// branch 'none found'
			return SIB_ID._tE6CAGBEEe2RjrkbQARhdg;
