...
public final class InitBrokerArea_N73BAFGLEe2J0bu3ffrh5w implements DIMEProcess {
	...
	public SIB_ID execute_VVWXEVGLEe2J0bu3ffrh5w(final Context ctx) {
		...
		List<de.ls5.dywa.generated.entity.onbroke.models.app.Offer> value27 = result;
		if (value27 != null) { // prevent null in lists
		ctx.offers_2EjYMVGLEe2J0bu3ffrh5w = new ArrayList<de.ls5.dywa.generated.entity.onbroke.models.app.Offer>(value27);
		}
		List<de.ls5.dywa.generated.entity.onbroke.models.app.Offer> value28 = result;
		if (value28 != null) { // prevent null in lists
		ctx.Retrieve_from_OfferSuccessRetrieved_VVjycVGLEe2J0bu3ffrh5w = new ArrayList<de.ls5.dywa.generated.entity.onbroke.models.app.Offer>(value28);
		}
		if (result.isEmpty()) {
			// branch 'none found'
	...
	public SIB_ID execute_wKmiQVGLEe2J0bu3ffrh5w(final Context ctx) {
		// put 'offer'.
		de.ls5.dywa.generated.entity.onbroke.models.app.Offer value29 = ctx.Iterate_OffersNextElement_bOWKwVGLEe2J0bu3ffrh5w;
		if (value29 != null) { // prevent null in lists
		ctx.approvedOffers_0JQJIVGLEe2J0bu3ffrh5w.add(value29);
		}
	...
	public SIB_ID execute___HYPHEN_MINUS__pAskVGLEe2J0bu3ffrh5w(final Context ctx) {
		...
		List<de.ls5.dywa.generated.entity.onbroke.models.app.Bidding> value30 = result;
		if (value30 != null) { // prevent null in lists
		ctx.biddings_3NYBcVGLEe2J0bu3ffrh5w = new ArrayList<de.ls5.dywa.generated.entity.onbroke.models.app.Bidding>(value30);
		}
		if (result.isEmpty()) {
			// branch 'none found'
