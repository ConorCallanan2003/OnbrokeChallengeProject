		...
		public class _4twukWAPEe2S6JM4Hx8SJwBranch{
			...
			private de.ls5.dywa.generated.rest.types.Comment
			 comment;
			
			@com.fasterxml.jackson.annotation.JsonProperty("comment")
			public de.ls5.dywa.generated.rest.types.Comment
			 getComment() {
				return comment;
			}
			
			@com.fasterxml.jackson.annotation.JsonProperty("comment")
			public void setComment(de.ls5.dywa.generated.rest.types.Comment
			 comment) {
