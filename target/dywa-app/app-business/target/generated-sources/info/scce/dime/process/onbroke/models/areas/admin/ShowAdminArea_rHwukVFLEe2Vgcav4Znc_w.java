...
public final class ShowAdminArea_rHwukVFLEe2Vgcav4Znc_w implements DIMEProcess {
	...
	public SIB_ID execute_ldrMkFLrEe2djpkPxa2Z3Q(final Context ctx) {
		...
		case "success": {
			List<de.ls5.dywa.generated.entity.onbroke.models.app.Feature> value0 = result.getSuccessReturn().getFeaturesForOffer();
			if (value0 != null) { // prevent null in lists
			ctx.InitAdminAreaSuccessFeaturesForOffer_ld7EMVLrEe2djpkPxa2Z3Q = new ArrayList<de.ls5.dywa.generated.entity.onbroke.models.app.Feature>(value0);
			}
			List<de.ls5.dywa.generated.entity.onbroke.models.app.Feature> value1 = result.getSuccessReturn().getFeaturesForBidding();
			if (value1 != null) { // prevent null in lists
			ctx.InitAdminAreaSuccessFeaturesForBidding_leDnEVLrEe2djpkPxa2Z3Q = new ArrayList<de.ls5.dywa.generated.entity.onbroke.models.app.Feature>(value1);
			}
			List<de.ls5.dywa.generated.entity.onbroke.models.app.User> value2 = result.getSuccessReturn().getUsers();
			if (value2 != null) { // prevent null in lists
			ctx.InitAdminAreaSuccessUsers_leMJ8VLrEe2djpkPxa2Z3Q = new ArrayList<de.ls5.dywa.generated.entity.onbroke.models.app.User>(value2);
			}
			List<de.ls5.dywa.generated.entity.onbroke.models.app.Offer> value3 = result.getSuccessReturn().getOffers();
			if (value3 != null) { // prevent null in lists
			ctx.InitAdminAreaSuccessOffers_leTesVLrEe2djpkPxa2Z3Q = new ArrayList<de.ls5.dywa.generated.entity.onbroke.models.app.Offer>(value3);
			}
			List<de.ls5.dywa.generated.entity.onbroke.models.app.Bidding> value4 = result.getSuccessReturn().getBiddings();
			if (value4 != null) { // prevent null in lists
			ctx.InitAdminAreaSuccessBiddings_lecBkVLrEe2djpkPxa2Z3Q = new ArrayList<de.ls5.dywa.generated.entity.onbroke.models.app.Bidding>(value4);
			}
			// branch 'success'
			return SIB_ID._ZewJIVFOEe2J0bu3ffrh5w;
		}
