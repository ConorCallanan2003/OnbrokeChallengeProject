...
public final class ShowCreateBiddingFeature_14a94VuVEe2nXJXMw4vrvg implements DIMEProcess {
	...
	public SIB_ID execute_wGmAIWGeEe2SIeIc0TVXOQ(final Context ctx) {
		...
		List<de.ls5.dywa.generated.entity.onbroke.models.app.Priority> value27 = result;
		if (value27 != null) { // prevent null in lists
		ctx.Retrieve_from_PrioritySuccessRetrieved_wG3F4WGeEe2SIeIc0TVXOQ = new ArrayList<de.ls5.dywa.generated.entity.onbroke.models.app.Priority>(value27);
		}
		if (result.isEmpty()) {
			// branch 'none found'
			return SIB_ID._5m73BFuVEe2nXJXMw4vrvg;
