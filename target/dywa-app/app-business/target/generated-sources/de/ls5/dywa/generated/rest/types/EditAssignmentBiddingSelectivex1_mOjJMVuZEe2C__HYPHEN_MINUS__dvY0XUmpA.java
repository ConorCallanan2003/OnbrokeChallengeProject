...
public class EditAssignmentBiddingSelectivex1_mOjJMVuZEe2C__HYPHEN_MINUS__dvY0XUmpA {
	...
	public static void copy(
		...
		if (source != null) {
			// original selective: EditAssignmentOfferSelectivex1x12x12_mOjJMVuZEe2C__HYPHEN_MINUS__dvY0XUmpA
			...
			if (!objectCache.containsSelective(cached, "EditAssignmentOfferSelectivex1x12x12_mOjJMVuZEe2C__HYPHEN_MINUS__dvY0XUmpA")) {
				de.ls5.dywa.generated.rest.types.EditAssignmentOfferSelectivex1x12x12_mOjJMVuZEe2C__HYPHEN_MINUS__dvY0XUmpA.copy(source, cached, objectCache);
			}
