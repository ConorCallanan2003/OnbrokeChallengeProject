...
public class EditAssignmentBiddingSelectivex1x10x10x18x18_mOjJMVuZEe2C__HYPHEN_MINUS__dvY0XUmpA {
	...
	public static void copy(
		...
		if (objectCache.containsSelective(to, "EditAssignmentBiddingSelectivex1x10x10x18x18_mOjJMVuZEe2C__HYPHEN_MINUS__dvY0XUmpA")) {
			return;
		}
		...
		objectCache.putSelective(to, "EditAssignmentBiddingSelectivex1x10x10x18x18_mOjJMVuZEe2C__HYPHEN_MINUS__dvY0XUmpA");
		...
		for (final de.ls5.dywa.generated.entity.onbroke.models.app.Feature
		 s : source) {
			// original selective: EditAssignmentFeatureSelectivex1x10x10x18x18x27x27_mOjJMVuZEe2C__HYPHEN_MINUS__dvY0XUmpA
		...
		if (source != null) {
			// original selective: EditAssignmentUserSelectivex1x10x10x18x18x2x2_mOjJMVuZEe2C__HYPHEN_MINUS__dvY0XUmpA
