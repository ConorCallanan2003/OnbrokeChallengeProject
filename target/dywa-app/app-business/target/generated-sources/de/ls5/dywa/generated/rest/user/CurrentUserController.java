...
public class CurrentUserController {
	...
	@javax.ws.rs.Path("User/{a:" +
		...
		"EditAssignmentUserSelectivex1x10x10x18x18x2x2_mOjJMVuZEe2C__HYPHEN_MINUS__dvY0XUmpA|" +
	...
	public de.ls5.dywa.generated.rest.types.User getEditAssignmentUserSelectivex1x10x10x18x18x2x2_mOjJMVuZEe2C__HYPHEN_MINUS__dvY0XUmpA() {
		...
		for (final de.ls5.dywa.generated.entity.onbroke.models.app.User concreteUser: subject.getuser_User()) {
			if (de.ls5.dywa.generated.entity.onbroke.models.app.User.class.isInstance(concreteUser)) {
				...
				if (!objectCache.containsSelective(result, "EditAssignmentUserSelectivex1x10x10x18x18x2x2_mOjJMVuZEe2C__HYPHEN_MINUS__dvY0XUmpA")) {
					de.ls5.dywa.generated.rest.types.EditAssignmentUserSelectivex1x10x10x18x18x2x2_mOjJMVuZEe2C__HYPHEN_MINUS__dvY0XUmpA.copy(currentUser, result, objectCache);
				}
