...
public class DecisionState extends info.scce.dime.rest.RESTBaseImpl implements info.scce.dime.rest.RESTBaseType
 {
	...
	public static DecisionState fromDywaEntity(final de.ls5.dywa.generated.entity.onbroke.models.app.DecisionState entity, info.scce.dime.rest.ObjectCache objectCache) {
	
		final DecisionState result;
	
		if (entity instanceof de.ls5.dywa.generated.entity.onbroke.models.app.DecisionState) {
			result = new de.ls5.dywa.generated.rest.types.DecisionState();
		}
