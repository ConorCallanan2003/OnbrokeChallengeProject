...
public class UserRole extends info.scce.dime.rest.RESTBaseImpl implements info.scce.dime.rest.RESTBaseType
 {
	...
	public static UserRole fromDywaEntity(final de.ls5.dywa.generated.entity.onbroke.models.app.UserRole entity, info.scce.dime.rest.ObjectCache objectCache) {
	
		final UserRole result;
	
		if (entity instanceof de.ls5.dywa.generated.entity.onbroke.models.app.UserRole) {
			result = new de.ls5.dywa.generated.rest.types.UserRole();
		}
