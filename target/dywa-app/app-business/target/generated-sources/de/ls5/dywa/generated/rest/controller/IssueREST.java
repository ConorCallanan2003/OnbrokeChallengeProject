...
public class IssueREST {
	...
	public de.ls5.dywa.generated.rest.types.Issue read_EditAssignmentIssueSelectivex1x12x12x20x20_mOjJMVuZEe2C__HYPHEN_MINUS__dvY0XUmpA(final long id) {
		...
		if (!objectCache.containsSelective(result, "EditAssignmentIssueSelectivex1x12x12x20x20_mOjJMVuZEe2C__HYPHEN_MINUS__dvY0XUmpA")) {
			de.ls5.dywa.generated.rest.types.EditAssignmentIssueSelectivex1x12x12x20x20_mOjJMVuZEe2C__HYPHEN_MINUS__dvY0XUmpA.copy(obj, result, objectCache);
		}

		return result;
	}

	public de.ls5.dywa.generated.rest.types.Issue readTransient_EditAssignmentIssueSelectivex1x12x12x20x20_mOjJMVuZEe2C__HYPHEN_MINUS__dvY0XUmpA(final de.ls5.dywa.generated.rest.types.Issue obj) {

		final de.ls5.dywa.generated.rest.types.Issue result;
		
		if (this.objectCache.containsSelective(obj, "EditAssignmentIssueSelectivex1x12x12x20x20_mOjJMVuZEe2C__HYPHEN_MINUS__dvY0XUmpA")) {
			return obj;
		}
		else {
			result = obj;
			this.objectCache.putSelective(obj, "EditAssignmentIssueSelectivex1x12x12x20x20_mOjJMVuZEe2C__HYPHEN_MINUS__dvY0XUmpA");
		}
			...
			{
				{
					...
					if (effectiveObj.iscomments_CommentSet()) {
						...
						for (final de.ls5.dywa.generated.rest.types.Comment e: existing) {
							...
							if (e.getDywaId() > 0) {
								// read_EditAssignmentCommentSelectivex1x12x12x20x20x22x22_mOjJMVuZEe2C__HYPHEN_MINUS__dvY0XUmpA
								fetchedValue = this.CommentREST.read_EditAssignmentCommentSelectivex1x12x12x20x20x22x22_mOjJMVuZEe2C__HYPHEN_MINUS__dvY0XUmpA(e.getDywaId());
							}
							else {
								// readTransient_EditAssignmentCommentSelectivex1x12x12x20x20x22x22_mOjJMVuZEe2C__HYPHEN_MINUS__dvY0XUmpA
								fetchedValue = this.CommentREST.readTransient_EditAssignmentCommentSelectivex1x12x12x20x20x22x22_mOjJMVuZEe2C__HYPHEN_MINUS__dvY0XUmpA(e);
							}
	...
	public de.ls5.dywa.generated.rest.types.Issue read_DetailsPageIssueSelectivex1_HVzS0GAMEe2S6JM4Hx8SJw(final long id) {
		...
		if (!objectCache.containsSelective(result, "DetailsPageIssueSelectivex1_HVzS0GAMEe2S6JM4Hx8SJw")) {
			de.ls5.dywa.generated.rest.types.DetailsPageIssueSelectivex1_HVzS0GAMEe2S6JM4Hx8SJw.copy(obj, result, objectCache);
		}

		return result;
	}

	public de.ls5.dywa.generated.rest.types.Issue readTransient_DetailsPageIssueSelectivex1_HVzS0GAMEe2S6JM4Hx8SJw(final de.ls5.dywa.generated.rest.types.Issue obj) {

		final de.ls5.dywa.generated.rest.types.Issue result;
		
		if (this.objectCache.containsSelective(obj, "DetailsPageIssueSelectivex1_HVzS0GAMEe2S6JM4Hx8SJw")) {
			return obj;
		}
		else {
			result = obj;
			this.objectCache.putSelective(obj, "DetailsPageIssueSelectivex1_HVzS0GAMEe2S6JM4Hx8SJw");
		}
			...
			{
				{
					...
					if (effectiveObj.iscomments_CommentSet()) {
						...
						for (final de.ls5.dywa.generated.rest.types.Comment e: existing) {
							...
							if (e.getDywaId() > 0) {
								// read_DetailsPageCommentSelectivex1x3x3_HVzS0GAMEe2S6JM4Hx8SJw
								fetchedValue = this.CommentREST.read_DetailsPageCommentSelectivex1x3x3_HVzS0GAMEe2S6JM4Hx8SJw(e.getDywaId());
							}
							else {
								// readTransient_DetailsPageCommentSelectivex1x3x3_HVzS0GAMEe2S6JM4Hx8SJw
								fetchedValue = this.CommentREST.readTransient_DetailsPageCommentSelectivex1x3x3_HVzS0GAMEe2S6JM4Hx8SJw(e);
							}
	...
	public de.ls5.dywa.generated.rest.types.Issue readTransient_DiscussionTableIssueSelectivex1_UOyxYVN9Ee2KQc5QIsW97w(final de.ls5.dywa.generated.rest.types.Issue obj) {
		...
		public java.util.Set<de.ls5.dywa.generated.rest.types.Issue> readAll_EditAssignmentIssueSelectivex1x12x12x20x20_mOjJMVuZEe2C__HYPHEN_MINUS__dvY0XUmpA() {
		...
		public java.util.Set<de.ls5.dywa.generated.rest.types.Issue> readAll_DetailsPageIssueSelectivex1_HVzS0GAMEe2S6JM4Hx8SJw() {
			...
			for (final de.ls5.dywa.generated.entity.onbroke.models.app.Issue s : objs) {
				...
				if (!objectCache.containsSelective(cached, "DetailsPageIssueSelectivex1_HVzS0GAMEe2S6JM4Hx8SJw")) {
					de.ls5.dywa.generated.rest.types.DetailsPageIssueSelectivex1_HVzS0GAMEe2S6JM4Hx8SJw.copy(s, cached, objectCache);
				}
	...
	public void update_EditAssignmentIssueSelectivex1x12x12x20x20_mOjJMVuZEe2C__HYPHEN_MINUS__dvY0XUmpA(final de.ls5.dywa.generated.rest.types.Issue value) {

		final de.ls5.dywa.generated.entity.onbroke.models.app.Issue obj = this.IssueController.read(value.getDywaId());
		
		this.update_EditAssignmentIssueSelectivex1x12x12x20x20_mOjJMVuZEe2C__HYPHEN_MINUS__dvY0XUmpA(value, obj);
	}

	public void update_EditAssignmentIssueSelectivex1x12x12x20x20_mOjJMVuZEe2C__HYPHEN_MINUS__dvY0XUmpA(final de.ls5.dywa.generated.rest.types.Issue value, final de.ls5.dywa.generated.entity.onbroke.models.app.Issue obj) {
		...
		if (effectiveValue.iscomments_CommentSet()) {
			...
			for (final de.ls5.dywa.generated.rest.types.Comment item : actual) {
				...
				if (item.getDywaId() == info.scce.dime.util.Constants.DYWA_ID_CREATE_NEW) {
					...
					//update_EditAssignmentCommentSelectivex1x12x12x20x20x22x22_mOjJMVuZEe2C__HYPHEN_MINUS__dvY0XUmpA
					this.CommentREST.update_EditAssignmentCommentSelectivex1x12x12x20x20x22x22_mOjJMVuZEe2C__HYPHEN_MINUS__dvY0XUmpA(item);
	...
	public void update_DetailsPageIssueSelectivex1_HVzS0GAMEe2S6JM4Hx8SJw(final de.ls5.dywa.generated.rest.types.Issue value) {

		final de.ls5.dywa.generated.entity.onbroke.models.app.Issue obj = this.IssueController.read(value.getDywaId());
		
		this.update_DetailsPageIssueSelectivex1_HVzS0GAMEe2S6JM4Hx8SJw(value, obj);
	}

	public void update_DetailsPageIssueSelectivex1_HVzS0GAMEe2S6JM4Hx8SJw(final de.ls5.dywa.generated.rest.types.Issue value, final de.ls5.dywa.generated.entity.onbroke.models.app.Issue obj) {
		...
		if (effectiveValue.iscomments_CommentSet()) {
			...
			for (final de.ls5.dywa.generated.rest.types.Comment item : actual) {
				...
				if (item.getDywaId() == info.scce.dime.util.Constants.DYWA_ID_CREATE_NEW) {
					...
					this.CommentREST.update_DetailsPageCommentSelectivex1x3x3_HVzS0GAMEe2S6JM4Hx8SJw(item);
					entity = this.CommentController.read(item.getDywaId());
				}
				// create transient
				else if (item.getDywaId() == info.scce.dime.util.Constants.DYWA_ID_TRANSIENT) {
