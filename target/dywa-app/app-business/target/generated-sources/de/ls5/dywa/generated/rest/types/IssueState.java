...
public class IssueState extends info.scce.dime.rest.RESTBaseImpl implements info.scce.dime.rest.RESTBaseType
 {
	...
	public static IssueState fromDywaEntity(final de.ls5.dywa.generated.entity.onbroke.models.app.IssueState entity, info.scce.dime.rest.ObjectCache objectCache) {
	
		final IssueState result;
	
		if (entity instanceof de.ls5.dywa.generated.entity.onbroke.models.app.IssueState) {
			result = new de.ls5.dywa.generated.rest.types.IssueState();
		}
