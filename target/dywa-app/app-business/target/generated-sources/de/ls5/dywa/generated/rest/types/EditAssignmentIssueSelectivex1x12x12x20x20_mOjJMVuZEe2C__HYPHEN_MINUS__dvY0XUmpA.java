...
public class EditAssignmentIssueSelectivex1x12x12x20x20_mOjJMVuZEe2C__HYPHEN_MINUS__dvY0XUmpA {
	...
	public static void copy(
		...
		if (objectCache.containsSelective(to, "EditAssignmentIssueSelectivex1x12x12x20x20_mOjJMVuZEe2C__HYPHEN_MINUS__dvY0XUmpA")) {
			return;
		}
		...
		objectCache.putSelective(to, "EditAssignmentIssueSelectivex1x12x12x20x20_mOjJMVuZEe2C__HYPHEN_MINUS__dvY0XUmpA");
		...
		for (final de.ls5.dywa.generated.entity.onbroke.models.app.Comment
		 s : source) {
			// original selective: EditAssignmentCommentSelectivex1x12x12x20x20x22x22_mOjJMVuZEe2C__HYPHEN_MINUS__dvY0XUmpA
