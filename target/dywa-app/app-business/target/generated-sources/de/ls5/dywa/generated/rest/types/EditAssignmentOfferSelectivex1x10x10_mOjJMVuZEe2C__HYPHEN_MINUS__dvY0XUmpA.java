...
public class EditAssignmentOfferSelectivex1x10x10_mOjJMVuZEe2C__HYPHEN_MINUS__dvY0XUmpA {
	...
	public static void copy(
		...
		if (objectCache.containsSelective(to, "EditAssignmentOfferSelectivex1x10x10_mOjJMVuZEe2C__HYPHEN_MINUS__dvY0XUmpA")) {
			return;
		}
		...
		objectCache.putSelective(to, "EditAssignmentOfferSelectivex1x10x10_mOjJMVuZEe2C__HYPHEN_MINUS__dvY0XUmpA");
		...
		for (final de.ls5.dywa.generated.entity.onbroke.models.app.Bidding
		 s : source) {
			// original selective: EditAssignmentBiddingSelectivex1x10x10x18x18_mOjJMVuZEe2C__HYPHEN_MINUS__dvY0XUmpA
		...
		for (final de.ls5.dywa.generated.entity.onbroke.models.app.Issue
		 s : source) {
			// original selective: EditAssignmentIssueSelectivex1x10x10x19x19_mOjJMVuZEe2C__HYPHEN_MINUS__dvY0XUmpA
