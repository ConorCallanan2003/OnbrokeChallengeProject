...
public class FeatureREST {
	...
	public de.ls5.dywa.generated.rest.types.Feature read_EditAssignmentFeatureSelectivex1x12x12x19x19x28x28_mOjJMVuZEe2C__HYPHEN_MINUS__dvY0XUmpA(final long id) {
		...
		if (!objectCache.containsSelective(result, "EditAssignmentFeatureSelectivex1x12x12x19x19x28x28_mOjJMVuZEe2C__HYPHEN_MINUS__dvY0XUmpA")) {
			de.ls5.dywa.generated.rest.types.EditAssignmentFeatureSelectivex1x12x12x19x19x28x28_mOjJMVuZEe2C__HYPHEN_MINUS__dvY0XUmpA.copy(obj, result, objectCache);
		}

		return result;
	}

	public de.ls5.dywa.generated.rest.types.Feature readTransient_EditAssignmentFeatureSelectivex1x12x12x19x19x28x28_mOjJMVuZEe2C__HYPHEN_MINUS__dvY0XUmpA(final de.ls5.dywa.generated.rest.types.Feature obj) {

		final de.ls5.dywa.generated.rest.types.Feature result;
		
		if (this.objectCache.containsSelective(obj, "EditAssignmentFeatureSelectivex1x12x12x19x19x28x28_mOjJMVuZEe2C__HYPHEN_MINUS__dvY0XUmpA")) {
			return obj;
		}
		else {
			result = obj;
			this.objectCache.putSelective(obj, "EditAssignmentFeatureSelectivex1x12x12x19x19x28x28_mOjJMVuZEe2C__HYPHEN_MINUS__dvY0XUmpA");
		}
	...
	public de.ls5.dywa.generated.rest.types.Feature read_NewOfferAeraFeatureSelectivex4_Ag9K4HfGEe20WYdcRLAoOw(final long id) {
		...
		if (!objectCache.containsSelective(result, "NewOfferAeraFeatureSelectivex4_Ag9K4HfGEe20WYdcRLAoOw")) {
			de.ls5.dywa.generated.rest.types.NewOfferAeraFeatureSelectivex4_Ag9K4HfGEe20WYdcRLAoOw.copy(obj, result, objectCache);
		}

		return result;
	}

	public de.ls5.dywa.generated.rest.types.Feature readTransient_NewOfferAeraFeatureSelectivex4_Ag9K4HfGEe20WYdcRLAoOw(final de.ls5.dywa.generated.rest.types.Feature obj) {

		final de.ls5.dywa.generated.rest.types.Feature result;
		
		if (this.objectCache.containsSelective(obj, "NewOfferAeraFeatureSelectivex4_Ag9K4HfGEe20WYdcRLAoOw")) {
			return obj;
		}
		else {
			result = obj;
			this.objectCache.putSelective(obj, "NewOfferAeraFeatureSelectivex4_Ag9K4HfGEe20WYdcRLAoOw");
		}
		...
		public java.util.Set<de.ls5.dywa.generated.rest.types.Feature> readAll_EditAssignmentFeatureSelectivex1x12x12x19x19x28x28_mOjJMVuZEe2C__HYPHEN_MINUS__dvY0XUmpA() {
		...
		public java.util.Set<de.ls5.dywa.generated.rest.types.Feature> readAll_NewOfferAeraFeatureSelectivex4_Ag9K4HfGEe20WYdcRLAoOw() {
			...
			for (final de.ls5.dywa.generated.entity.onbroke.models.app.Feature s : objs) {
				...
				if (!objectCache.containsSelective(cached, "NewOfferAeraFeatureSelectivex4_Ag9K4HfGEe20WYdcRLAoOw")) {
					de.ls5.dywa.generated.rest.types.NewOfferAeraFeatureSelectivex4_Ag9K4HfGEe20WYdcRLAoOw.copy(s, cached, objectCache);
				}
	...
	public void update_EditAssignmentFeatureSelectivex1x12x12x19x19x28x28_mOjJMVuZEe2C__HYPHEN_MINUS__dvY0XUmpA(final de.ls5.dywa.generated.rest.types.Feature value) {

		final de.ls5.dywa.generated.entity.onbroke.models.app.Feature obj = this.FeatureController.read(value.getDywaId());
		
		this.update_EditAssignmentFeatureSelectivex1x12x12x19x19x28x28_mOjJMVuZEe2C__HYPHEN_MINUS__dvY0XUmpA(value, obj);
	}

	public void update_EditAssignmentFeatureSelectivex1x12x12x19x19x28x28_mOjJMVuZEe2C__HYPHEN_MINUS__dvY0XUmpA(final de.ls5.dywa.generated.rest.types.Feature value, final de.ls5.dywa.generated.entity.onbroke.models.app.Feature obj) {
	...
	public void update_NewOfferAeraFeatureSelectivex4_Ag9K4HfGEe20WYdcRLAoOw(final de.ls5.dywa.generated.rest.types.Feature value) {

		final de.ls5.dywa.generated.entity.onbroke.models.app.Feature obj = this.FeatureController.read(value.getDywaId());
		
		this.update_NewOfferAeraFeatureSelectivex4_Ag9K4HfGEe20WYdcRLAoOw(value, obj);
	}

	public void update_NewOfferAeraFeatureSelectivex4_Ag9K4HfGEe20WYdcRLAoOw(final de.ls5.dywa.generated.rest.types.Feature value, final de.ls5.dywa.generated.entity.onbroke.models.app.Feature obj) {
