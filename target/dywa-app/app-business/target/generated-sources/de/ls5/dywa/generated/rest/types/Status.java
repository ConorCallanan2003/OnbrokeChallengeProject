...
public class Status extends info.scce.dime.rest.RESTBaseImpl implements info.scce.dime.rest.RESTBaseType
 {
	...
	public static Status fromDywaEntity(final de.ls5.dywa.generated.entity.onbroke.models.app.Status entity, info.scce.dime.rest.ObjectCache objectCache) {
	
		final Status result;
	
		if (entity instanceof de.ls5.dywa.generated.entity.onbroke.models.app.Status) {
			result = new de.ls5.dywa.generated.rest.types.Status();
		}
