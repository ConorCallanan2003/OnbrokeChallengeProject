...
public class OfferSelective {
	...
	public static void copy(
		...
		if (source != null) {
			// original selective: StatusSelective
			...
			if (!objectCache.containsSelective(cached, "StatusSelective")) {
				de.ls5.dywa.generated.rest.types.StatusSelective.copy(source, cached, objectCache);
			}
