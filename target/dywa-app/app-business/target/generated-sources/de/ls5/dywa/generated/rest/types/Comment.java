...
public interface Comment extends info.scce.dime.rest.RESTBaseType  {
	...
	java.lang.String
	 getcommentFirstName();
	boolean iscommentFirstNameSet();

	void setcommentFirstName(final java.lang.String
	 commentFirstName);
	java.lang.String
	 getcommentLastName();
	boolean iscommentLastNameSet();

	void setcommentLastName(final java.lang.String
	 commentLastName);
