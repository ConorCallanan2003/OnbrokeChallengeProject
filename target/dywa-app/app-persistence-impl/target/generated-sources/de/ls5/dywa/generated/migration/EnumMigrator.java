...
public class EnumMigrator {
    ...
    public void migrate() {
        ...
        em.flush();
    			...
    			setupStatus(de.ls5.dywa.generated.entity.onbroke.models.app.Status.open, de.ls5.dywa.generated.entity.onbroke.models.app.Status.closed);
    }
	...
	private void setupStatus(de.ls5.dywa.generated.entity.onbroke.models.app.Status... values) {

	    for (de.ls5.dywa.generated.entity.onbroke.models.app.Status value : values) {
	        final TypedQuery<de.ls5.dywa.generated.entity.onbroke.models.app.StatusEntity> query = em.createQuery(
	                "SELECT o FROM de.ls5.dywa.generated.entity.onbroke.models.app.StatusEntity o WHERE o.name_ = :name", de.ls5.dywa.generated.entity.onbroke.models.app.StatusEntity.class);
	        query.setParameter("name", value.name());

	        final List<de.ls5.dywa.generated.entity.onbroke.models.app.StatusEntity> res = query.getResultList();
	        final de.ls5.dywa.generated.entity.onbroke.models.app.StatusEntity entity;

	        switch (res.size()) {
	            case 0:
	                entity = new de.ls5.dywa.generated.entity.onbroke.models.app.StatusEntity();
	                entity.setDywaName(value.name());
	                em.persist(entity);
	                break;
	            case 1:
