...
public class IssueSearch implements Issue {
	...
	static {
		java.lang.Class<?> targetClass = IssueImpl.class;
	...
	public IssueSearch(java.lang.String name) {
	...
	public java.lang.String gettitle() {
		return (java.lang.String) this.attributeMap.get(dywaIdToJpqlAttr.get(61L));
	}
	...
	(java.lang.String object) {
			...
			this.attributeMap.put(dywaIdToJpqlAttr.get(61L), object);
	}
	@java.lang.Override
	public java.util.List<de.ls5.dywa.generated.entity.onbroke.models.app.Comment> getcomments_Comment() {
		return (java.util.List<de.ls5.dywa.generated.entity.onbroke.models.app.Comment>) this.listAttributeMap.get(dywaIdToJpqlAttr.get(62L));
	}
	public void setcomments_Comment
	(java.util.List<de.ls5.dywa.generated.entity.onbroke.models.app.Comment> object) {
			
				for(de.ls5.dywa.generated.entity.onbroke.models.app.Comment p: object){
					 if (! (p instanceof de.ls5.dywa.generated.entity.onbroke.models.app.Comment)) {
							throw new java.lang.RuntimeException("Wrong type");
				}
				}
			this.listAttributeMap.put(dywaIdToJpqlAttr.get(62L), object);
	}
	@java.lang.Override
	public de.ls5.dywa.generated.entity.onbroke.models.app.IssueState getstate() {
		return de.ls5.dywa.generated.entity.onbroke.models.app.IssueState.forId(((de.ls5.dywa.generated.entity.onbroke.models.app.IssueStateEntity) this.attributeMap.get(dywaIdToJpqlAttr.get(63L))).getDywaId());
	}
	public void setstate
	(de.ls5.dywa.generated.entity.onbroke.models.app.IssueState object) {
			
				if (! (object instanceof de.ls5.dywa.generated.entity.onbroke.models.app.IssueState)) {
							throw new java.lang.RuntimeException("Wrong type");
				}
			this.attributeMap.put(dywaIdToJpqlAttr.get(63L), object != null ? object.getEntityAs(IssueStateEntity.class)/*1*/ : null);
	}
